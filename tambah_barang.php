...
<html lang="en">
 ...
 <h3>Tambah data Barang</h3>
    <form action="proses_tambah_barang.php" method="post">
        ...
        Tanggal Produksi :
        <input type="date" name="tanggal_produksi" value="" class="form-control">
        Tempat Produksi :
        <textarea name="tempat_produksi" class="form-control" rows="4"></textarea>
        ...
        <select name="kode_barang" class="form-control">
            ...
            { echo '<option value="'.$data_jenis_barang['kode_barang'].'">
                '.$data_jenis_barang['jenis_barang'].'</option>';
            }
            ?>
            </select><tr>
        <td>
